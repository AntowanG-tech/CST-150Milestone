...
namespace CST_150Milestone3
{
    public class Blanket
    {
        ...
        {
            String blanketString = "ID: " + this.id + Environment.NewLine + "Type: " + type + Environment.NewLine + "Shape: " + shape + Environment.NewLine + "Color: " + color + Environment.NewLine + "Material: " + material + Environment.NewLine + "Size: " + size + Environment.NewLine + "Price: " + price + Environment.NewLine;
